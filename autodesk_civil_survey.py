...
IMAGE_MAPPING = {
    ...
    "CI02": "fy27-water-image-02.webp",
    "CI03": "brand-image-prototype-1-dark.webp",
    "CI04": "Construction-CCEED-China-0644_with_overlay.webp",
    "CI05": "brand-image-prototype-4-dark.webp"
}
...
# Brand Header Layout
header_html = '<div style="display:flex;align-items:end;justify-content:space-between;flex-wrap:wrap;margin:12px 0 16px;gap:16px;"><div><div style="font-size:.85rem;color:#FFFF00;letter-spacing:.12em;text-transform:uppercase;font-weight:700;">IFM Maturity Assessment</div><div style="font-size:2.0rem;font-weight:700;color:#FFFFFF;letter-spacing:-.03em;">土木・インフラ CIM成熟度アセスメント</div></div><div style="font-size:.85rem;color:#D5D5CB;">for Autodesk Design &amp; Make workflows</div></div>'
...
with tabs[0]:
    ...
    with col_left_form:
        if st.session_state.is_submitted:
            ...
            specific_team = st.text_input("部署名・チーム名 (任意)", placeholder="例: 土木設計部 インフラ課", value=st.session_state.get("res_team", ""))
