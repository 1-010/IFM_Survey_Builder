...
IMAGE_MAPPING = {
    ...
    "MF02": "brand-image-prototype-1-dark.webp",
    ...
    "MF07": "fy27-water-image-02.webp",
    "MF08": "fy27-aec-forma-industry-cloud-imagery.webp"
}
        ...
        if st.session_state.is_submitted:
            ...
            if pdf_data:
                st.download_button(
                    ...
                    data=pdf_data,
                    file_name=f"Autodesk_MFG_Digital_Report_{active_survey_id}.pdf",
            ...
            specific_team = st.text_input("部署名・チーム名 (任意)", placeholder="例: 製品開発部 設計課", value=st.session_state.get("res_team", ""))
