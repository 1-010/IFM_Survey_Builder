...
IMAGE_MAPPING = {
    ...
    "AE06": "fy27-dm-fusion-industry-cloud-imagery.webp",
    "AE07": "Tech-Center-Birmingham-industrial-robots-086_with_overlay.webp",
    "AE08": "brand-image-prototype-4-dark.webp"
}
...
# Brand Header Layout
header_html = '<div style="display:flex;align-items:end;justify-content:space-between;flex-wrap:wrap;margin:12px 0 16px;gap:16px;"><div><div style="font-size:.78rem;color:#D5D5CB;letter-spacing:.12em;text-transform:uppercase;font-weight:600;">IFM Maturity Assessment</div><div style="font-size:1.85rem;font-weight:700;color:#FFFFFF;letter-spacing:-.03em;">建築設計・施工 BIM適性診断</div></div><div style="font-size:.8rem;color:#D5D5CB;">for Autodesk Design &amp; Make workflows</div></div>'
...
with tabs[0]:
    ...
    with col_left_form:
        if st.session_state.is_submitted:
            ...
            specific_team = st.text_input("部署名・チーム名 (任意)", placeholder="例: 設計部 開発課", value=st.session_state.get("res_team", ""))
