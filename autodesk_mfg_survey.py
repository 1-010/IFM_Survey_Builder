...
def get_mfg_questions():
    ...
    if DATA_JSON.exists():
        with open(DATA_JSON, "r", encoding="utf-8") as f:
            data = json.load(f)
        return pd.DataFrame(data.get("mfg_questions", [])), "default", None
    return pd.DataFrame(), "default", None

q_df, active_survey_id, client_name = get_mfg_questions()
...
IMAGE_MAPPING = {
    ...
    "MF03": "brand-image-prototype-4-dark.webp",
    "MF04": "fy27-dm-fusion-industry-cloud-imagery.webp",
    "MF05": "brand-image-prototype-1-dark.webp",
    "MF06": "Construction-CCEED-China-0644_with_overlay.webp",
    "MF07": "fy27-dm-digital-factory-campaign-visual-01.webp",
...
header_html = f'<div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; margin-top: 10px; margin-bottom: 10px; gap: 20px;"><div style="width: 220px; display: flex; align-items: center;">{stacked_logo_svg}</div><div style="text-align: right; min-width: 250px;"><div style="font-size: 0.75rem; color: #666666; letter-spacing: 0.15em; text-transform: uppercase; font-weight: 600; margin-bottom: 2px;">Maturity Evaluation Platform</div><div style="font-size: 1.7rem; font-weight: 700; color: #FFFFFF; letter-spacing: -0.03em;">製品設計・開発 デジタル適性診断</div></div></div>'
...
with tabs[0]:
    ...
    with col_left_form:
        if st.session_state.is_submitted:
            ...
            PRODUCT_PROPOSALS = {
                "MF01": {
                    "title": "3D機械設計・BOM同期プラットフォーム - Autodesk Inventor",
                    "desc": "3D詳細設計と部品構成表（BOM）の動的連携・作成プロセスに大きなGapが見られます。プロフェッショナル3D設計ソフトInventorを使用し、設計アセンブリとBOMの一貫した自動同期を図り、部品抜けや手作業の修正コストを削減できます。",
                    "url": "https://www.autodesk.com/products/inventor/overview"
                },
                "MF02": {
                    "title": "設計者向け高度FEAシミュレーション - Autodesk Inventor Nastran",
                    "desc": "設計途中段階における強度・熱応力解析シミュレーションの実施度に改善の余地があります。CADと完全一体化したInventor Nastranの導入により、設計検証を設計者のデスクトップ上で迅速に実行し、実機試作手戻りを劇的に減少させます。",
                    "url": "https://www.autodesk.com/products/inventor-nastran/overview"
                },
                "MF03": {
                    "title": "製品データ管理（PDM）ソリューション - Autodesk Vault",
                    "desc": "図面のバージョン管理や承認ワークフロー、リビジョン管理の統制（PDM）に課題感が見られます。Vaultを導入することで、最新データの検索時間や不整合をゼロにし、セキュアな設計データ管理を実現します。",
                    "url": "https://www.autodesk.com/products/vault/overview"
                },
                "MF04": {
                    "title": "クラウド統合製品開発プラットフォーム - Autodesk Fusion",
                    "desc": "社内外のサプライヤーとの3D設計レビュー、クラウド協調設計に大きな乖離が見られます。Fusionを使用することで、Webブラウザのみで3Dアセンブリを共同閲覧・マークアップし、世界中のチームとのデータ共有をシームレスに行えます。",
                    "url": "https://www.autodesk.com/products/fusion-360/overview"
                },
                "MF05": {
                    "title": "AI形状生成テクノロジー - Autodesk Fusion ジェネレーティブデザイン",
                    "desc": "ジェネレーティブデザイン・AIによる最適形状設計にGapが見られます。目標重量・材料・製造方法などの制約条件をセットし、AIに何十通りもの最適モデルを自律生成させることで、大幅な軽量化と材料費節減を実現します。",
                    "url": "https://www.autodesk.com/products/fusion-360/generative-design"
                },
                "MF06": {
                    "title": "CAD/CAM統合製造プラットフォーム - Autodesk Fusion CAM",
                    "desc": "3D設計と工作機械用の加工経路（NCデータ）の連携に課題が見られます。同一環境内でCADとCAMが統合されたFusion CAMにより、設計変更がツールパスに即座に追従し、プログラミング手戻りを一掃します。",
                    "url": "https://www.autodesk.com/products/fusion-360/cam"
                },
                "MF07": {
                    "title": "ルールベース設計自動化 - Inventor iLogic",
                    "desc": "アセンブリやバリエーション設計の自動化・効率化に大きなGapがあります。iLogicのルールエンジンを構築し、受注仕様パラメータを入力するだけで3DモデルとBOM、2D図面一式を自動生成・出力させることができます。",
                    "url": "https://www.autodesk.com/products/inventor/overview"
                },
                "MF08": {
                    "title": "電気・機械（ECAD/MCAD）3D協調設計 - Autodesk Fusion ECAD",
                    "desc": "基板設計と筐体設計のリアルタイムな同期、干渉チェックプロセスに乖離があります。FusionのECAD/MCAD双方向オンライン協調機能により、基板レイアウト変更と3D機械設計データの干渉を即座に連動・解消させます。",
                    "url": "https://www.autodesk.com/products/fusion-360/electronics"
                }
            }
            ...
            if display_count == 0:
                st.markdown(
                    ...
                    <div class="proposal-card">
                        ...
                        <div class="proposal-desc">お客様の製造デジタル推進レベルはすでにトップクラスにあります。AutoCAD、Inventor、Vault、Nastran、Fusionを網羅したPDMCコレクションにより、製品開発から製造ライン構築、サプライチェーン協調までの全ライフサイクルを統合できます。</div>
